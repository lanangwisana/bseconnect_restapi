...
<body class = "bg-gray-100">
    <nav class="bg-white border-gray-200 dark:bg-gray-900 border-b-2 border-gray-100">
        ...
        <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 ml-[600px] w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
            ...
            <div class="hidden w-full ml-8 mt-1 md:block md:w-auto" id="navbar-default">
                ...
                <li>
                    <a href="#" class="block pb-2 px-3 text-white bg-blue-700 rounded underline underline-offset-[34px] md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Dashboard</a>
                </li>
                <li>
                    <a href="/presensi" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Presensi</a>
                </li>
                <li>
    ...
    <div class = "bg-white font-semibold p-4 text-2xl">
